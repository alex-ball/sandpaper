...
#> → Creating Lesson in /tmp/RtmpQwfBDN/file1e811450c2e3...
...
#> → Creating Lesson in /tmp/RtmpQwfBDN/file1e811450c2e3...
#> ☐ Edit /tmp/RtmpQwfBDN/file1e811450c2e3/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpQwfBDN/file1e811450c2e3...
#> ✔ First episode created in /tmp/RtmpQwfBDN/file1e811450c2e3/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpQwfBDN/file1e811450c2e3...
...
#> → Creating Lesson in /tmp/RtmpQwfBDN/file1e811450c2e3...
#> ✔ Lesson successfully created in /tmp/RtmpQwfBDN/file1e811450c2e3
#> → Creating Lesson in /tmp/RtmpQwfBDN/file1e811450c2e3...
#> /tmp/RtmpQwfBDN/file1e811450c2e3
