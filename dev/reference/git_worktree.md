...
#> ℹ Lesson bootstrapped in 3.634873 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01434684 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 101c2b7] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpQwfBDN/REMOTE-1e8111fb67a6
...
#> From /tmp/RtmpQwfBDN/REMOTE-1e8111fb67a6
...
#>   /tmp/RtmpQwfBDN/file1e812e5c83a9/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 101c2b7)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 101c2b7 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 058674c] Initializing gh-pages branch
...
#>   /tmp/RtmpQwfBDN/file1e812e5c83a9/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 058674c)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 058674c Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.31 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpQwfBDN/file1e812e5c83a9/lesson-example/site/built", "/tmp/RtmpQwfBDN/file1e812e5c83a9/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpQwfBDN/file1e812e5c83a9/lesson-example/site/docs", "/tmp/RtmpQwfBDN/file1e812e5c83a9/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpQwfBDN/file1e812e5c83a9/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpQwfBDN/REMOTE-1e8111fb67a6)
#> /tmp/RtmpQwfBDN/REMOTE-1e8111fb67a6
