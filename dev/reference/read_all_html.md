...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpQvWomo/file1c5da3add19': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpQvWomo/file1c5da3add19/index.html
#> /tmp/RtmpQvWomo/file1c5da3add19/instructor/index.html
#> 
```
