...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d2e8eaadd...
...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d2e8eaadd...
#> ☐ Edit /tmp/RtmpQvWomo/file1c5d2e8eaadd/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d2e8eaadd...
#> ✔ First episode created in /tmp/RtmpQvWomo/file1c5d2e8eaadd/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d2e8eaadd...
...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d2e8eaadd...
#> ✔ Lesson successfully created in /tmp/RtmpQvWomo/file1c5d2e8eaadd
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d2e8eaadd...
#> /tmp/RtmpQvWomo/file1c5d2e8eaadd
