...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpoKugO1/file1cfe708e6824': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpoKugO1/file1cfe708e6824...
...
#> → Creating Lesson in /tmp/RtmpoKugO1/file1cfe708e6824...
#> ☐ Edit /tmp/RtmpoKugO1/file1cfe708e6824/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpoKugO1/file1cfe708e6824...
#> ✔ First episode created in /tmp/RtmpoKugO1/file1cfe708e6824/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpoKugO1/file1cfe708e6824...
...
#> → Creating Lesson in /tmp/RtmpoKugO1/file1cfe708e6824...
#> ✔ Lesson successfully created in /tmp/RtmpoKugO1/file1cfe708e6824
#> → Creating Lesson in /tmp/RtmpoKugO1/file1cfe708e6824...
#> /tmp/RtmpoKugO1/file1cfe708e6824
...
#> [1] "/tmp/RtmpoKugO1/file1cfe708e6824/episodes/introduction.Rmd"
#> [2] "/tmp/RtmpoKugO1/file1cfe708e6824/episodes/files/hi.md"     
#> 
#> $CODE_OF_CONDUCT.md
#> /tmp/RtmpoKugO1/file1cfe708e6824/CODE_OF_CONDUCT.md
#> 
#> $CONTRIBUTING.md
#> /tmp/RtmpoKugO1/file1cfe708e6824/CONTRIBUTING.md
#> 
#> $LICENSE.md
#> /tmp/RtmpoKugO1/file1cfe708e6824/LICENSE.md
#> 
#> $README.md
#> /tmp/RtmpoKugO1/file1cfe708e6824/README.md
#> 
#> $index.md
#> /tmp/RtmpoKugO1/file1cfe708e6824/index.md
#> 
#> $links.md
#> /tmp/RtmpoKugO1/file1cfe708e6824/links.md
#> 
#> $`instructors/instructor-notes.md`
#> /tmp/RtmpoKugO1/file1cfe708e6824/instructors/instructor-notes.md
#> 
#> $`learners/reference.md`
#> /tmp/RtmpoKugO1/file1cfe708e6824/learners/reference.md
#> 
#> $`learners/setup.md`
#> /tmp/RtmpoKugO1/file1cfe708e6824/learners/setup.md
#> 
#> $`profiles/learner-profiles.md`
#> /tmp/RtmpoKugO1/file1cfe708e6824/profiles/learner-profiles.md
#> 
