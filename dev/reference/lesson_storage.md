...
[`.lesson_store()`](https://carpentries.github.io/sandpaper/dev/reference/dot-lesson_store.md)
...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d1948f838...
...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d1948f838...
#> ☐ Edit /tmp/RtmpQvWomo/file1c5d1948f838/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d1948f838...
#> ✔ First episode created in /tmp/RtmpQvWomo/file1c5d1948f838/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d1948f838...
...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d1948f838...
#> ✔ Lesson successfully created in /tmp/RtmpQvWomo/file1c5d1948f838
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d1948f838...
#> /tmp/RtmpQvWomo/file1c5d1948f838
...
#>     overview: FALSE
#>     path: /tmp/RtmpQvWomo/file1c5d1948f838
#>     reset: function () 
#>     rmd: FALSE
#>     sandpaper: TRUE
