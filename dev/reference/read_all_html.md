...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpoKugO1/file1cfe423bb633': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpoKugO1/file1cfe423bb633/index.html
#> /tmp/RtmpoKugO1/file1cfe423bb633/instructor/index.html
#> 
```
