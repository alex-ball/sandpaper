...
#> ℹ Lesson bootstrapped in 3.633566 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01277542 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.67 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) fd777c5] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmppAvZfv/REMOTE-1d21450dbb22
...
#> From /tmp/RtmppAvZfv/REMOTE-1d21450dbb22
...
#>   /tmp/RtmppAvZfv/file1d2113dcd167/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at fd777c5)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at fd777c5 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) aed607a] Initializing gh-pages branch
...
#>   /tmp/RtmppAvZfv/file1d2113dcd167/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at aed607a)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at aed607a Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.22 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmppAvZfv/file1d2113dcd167/lesson-example/site/built", "/tmp/RtmppAvZfv/file1d2113dcd167/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmppAvZfv/file1d2113dcd167/lesson-example/site/docs", "/tmp/RtmppAvZfv/file1d2113dcd167/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmppAvZfv/file1d2113dcd167/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmppAvZfv/REMOTE-1d21450dbb22)
#> /tmp/RtmppAvZfv/REMOTE-1d21450dbb22
