...
#> ℹ Lesson bootstrapped in 3.191102 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.009927034 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.22 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) 8e35ced] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpQvWomo/REMOTE-1c5d51b65ca4
...
#> From /tmp/RtmpQvWomo/REMOTE-1c5d51b65ca4
...
#>   /tmp/RtmpQvWomo/file1c5d2a413d78/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 8e35ced)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 8e35ced Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) e7a6f9c] Initializing gh-pages branch
...
#>   /tmp/RtmpQvWomo/file1c5d2a413d78/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at e7a6f9c)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at e7a6f9c Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 0.34 seconds
tik <- Sys.time()
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.38 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpQvWomo/file1c5d2a413d78/lesson-example/site/built", "/tmp/RtmpQvWomo/file1c5d2a413d78/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpQvWomo/file1c5d2a413d78/lesson-example/site/docs", "/tmp/RtmpQvWomo/file1c5d2a413d78/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpQvWomo/file1c5d2a413d78/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpQvWomo/REMOTE-1c5d51b65ca4)
#> /tmp/RtmpQvWomo/REMOTE-1c5d51b65ca4
