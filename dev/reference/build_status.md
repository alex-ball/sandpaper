...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmppAvZfv/file1d21e540bc2': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmppAvZfv/file1d21e540bc2...
...
#> → Creating Lesson in /tmp/RtmppAvZfv/file1d21e540bc2...
#> ☐ Edit /tmp/RtmppAvZfv/file1d21e540bc2/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmppAvZfv/file1d21e540bc2...
#> ✔ First episode created in /tmp/RtmppAvZfv/file1d21e540bc2/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmppAvZfv/file1d21e540bc2...
...
#> → Creating Lesson in /tmp/RtmppAvZfv/file1d21e540bc2...
#> ✔ Lesson successfully created in /tmp/RtmppAvZfv/file1d21e540bc2
#> → Creating Lesson in /tmp/RtmppAvZfv/file1d21e540bc2...
#> /tmp/RtmppAvZfv/file1d21e540bc2
...
#> $build
#> /tmp/RtmppAvZfv/file1d21e540bc2/episodes/introduction.md
#> /tmp/RtmppAvZfv/file1d21e540bc2/index.md
#> 
#> $new
#>                                                                              file
#> /tmp/RtmppAvZfv/file1d21e540bc2/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmppAvZfv/file1d21e540bc2/index.md                                 index.md
#>                                                                                  checksum
#> /tmp/RtmppAvZfv/file1d21e540bc2/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmppAvZfv/file1d21e540bc2/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                               built
#> /tmp/RtmppAvZfv/file1d21e540bc2/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmppAvZfv/file1d21e540bc2/index.md                        site/built/index.md
#>                                                                date
#> /tmp/RtmppAvZfv/file1d21e540bc2/episodes/introduction.md 2026-04-02
#> /tmp/RtmppAvZfv/file1d21e540bc2/index.md                 2026-04-02
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-04-02
#> 2        site/built/index.md 2026-04-02
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmppAvZfv/file1d21e540bc2/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmppAvZfv/file1d21e540bc2/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-04-02
#> 1        site/built/index.md 2026-04-02
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
