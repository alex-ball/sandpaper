...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d26851e07...
...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d26851e07...
#> ☐ Edit /tmp/RtmpQvWomo/file1c5d26851e07/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d26851e07...
#> ✔ First episode created in /tmp/RtmpQvWomo/file1c5d26851e07/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d26851e07...
...
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d26851e07...
#> ✔ Lesson successfully created in /tmp/RtmpQvWomo/file1c5d26851e07
#> → Creating Lesson in /tmp/RtmpQvWomo/file1c5d26851e07...
#> /tmp/RtmpQvWomo/file1c5d26851e07
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpQvWomo/file1c5d26851e07/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpQvWomo/file1c5d26851e07/episodes/using-r.Rmd.
#> /tmp/RtmpQvWomo/file1c5d26851e07/episodes/using-r.Rmd
